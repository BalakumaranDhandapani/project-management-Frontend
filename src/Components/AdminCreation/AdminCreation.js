            ...
            <div>
                ...
                <MaterialTable
                    ...
                    columns={[
                        ...
                        { title: 'DESIGNATION', field: 'password', render: rowData => { return (<h5 style={{ fontSize: 13, fontFamily: 'Poppins-Medium' }}>{rowData.designation}</h5>) } },
                        { title: 'USER ID', field: 'password', render: rowData => { return (<h5 style={{ fontSize: 13, fontFamily: 'Poppins-Medium' }}>{rowData.user_id}</h5>) } },
                    ]}
                                    ...
                                    buttons: [
                                        {
                                            ...
                                            onClick: () => {
                                                const options = {
                                                    url: api.USER_CREATION + rowData._id,
                                                    method: 'DELETE',
                                                    headers: {
                                                        'Content-Type': 'application/json',
